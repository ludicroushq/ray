...
- Treat `.ruler` as the source of truth for agent instructions and skills. Do not edit generated `AGENTS.md`, `CLAUDE.md`, `.agents/skills`, or `.claude/skills`; run `bun ruler` after source changes and `bun run skills:update` to update lockfile-managed external skills.
